...
#		-> Modified line 43
# Feb 2025: Tested with Python version 3.11.5 with tensorflow 2.15.0. 
...
model.fit(X, y, epochs=100, batch_size=100)	# Try playing with these hyperparameters to see what the effect is.
